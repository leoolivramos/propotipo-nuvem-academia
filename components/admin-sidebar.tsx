...
const navItems = [
  ...
  { href: "/admin/infraestrutura", label: "Infraestrutura", icon: Cpu },
...
export function AdminSidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 flex w-16 flex-col items-center bg-sidebar py-4 lg:w-72 lg:items-stretch lg:px-4">
      <Link href="/admin/dashboard" className="flex items-center gap-3 px-2 py-2">
        ...
        <div className="hidden lg:block">
          ...
          <p className="text-[10px] text-sidebar-foreground/50">Administrador do Sistema</p>
        </div>
      </Link>
      ...
      <div className="flex flex-col items-center gap-2 lg:items-stretch">
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            ...
            <TooltipContent side="right" className="lg:hidden">Alternar Tema</TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <div className="flex items-center gap-3 rounded-lg px-2 py-2">
          ...
          <div className="hidden min-w-0 lg:block">
            ...
            <p className="truncate text-[10px] text-sidebar-foreground/50">Admin do Sistema</p>
          </div>
          <TooltipProvider delayDuration={0}>
            <Tooltip>
              <TooltipTrigger asChild>
